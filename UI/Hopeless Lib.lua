--[[
    ...
    Please give credits if you used this ui library or we will take force to demolished it :)
]]
...
local Library do
    ...
    Library = {
        ...
        Folders = {
            Directory = "Hopeless",
            Configs = "Hopeless/Configs",
            Assets = "Hopeless/Assets",
        },

        Images = {
            ["Saturation"] = {"Saturation.png", "https://github.com/BIvck/images/blob/main/saturation.png?raw=true" },
            ["Value"] = { "Value.png", "https://github.com/BIvck/images/blob/main/value.png?raw=true" },
            ["Hue"] = { "Hue.png", "https://github.com/BIvck/images/blob/main/horizontalhue.png?raw=true" },
            ["Checkers"] = { "Checkers.png", "https://github.com/BIvck/images/blob/main/checkers.png?raw=true" },
        },
    ...
    local CustomFont = { } do
        ...
        CustomFont:New("PoppinsMedium", 400, "Regular", {
            Url = "https://github.com/BIvck/luas/raw/refs/heads/main/fonts/Poppins-Medium.ttf"
        })
    ...
    local Components = { } do -- Components
        ...
        Components.Slider = function(self, Data)
            ...
            Data.Decimals = Data.Decimals or 1
            Data.Suffix = Data.Suffix or ""
            Data.Default = Data.Default == nil and Data.Min or Data.Default
            ...
            function Slider:Set(Value)
                ...
                if range ~= 0 then
                    normalized = MathClamp((Value - Data.Min) / range, 0, 1)
                end

                self.Value = MathClamp(Library:Round(Data.Min + normalized * range, Data.Decimals), Data.Min, Data.Max)
                Library.Flags[self.Flag] = self.Value

                Items["Accent"]:Tween(TweenInfo.new(0.21, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2New(normalized, 0, 1, 0)})
            ...
            Items["RealSlider"]:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    local sliderPosX = Items["RealSlider"].Instance.AbsolutePosition.X
                    local sliderSizeX = Items["RealSlider"].Instance.AbsoluteSize.X
                    local SizeX = MathClamp((Input.Position.X - sliderPosX) / sliderSizeX, 0, 1)
    ...
    Library.AccentColorRgb = function(self)
        local Accent = self.Theme.Accent
        return string.format("rgb(%d, %d, %d)", math.floor(Accent.R * 255), math.floor(Accent.G * 255), math.floor(Accent.B * 255))
    end

    Library.AccentText = function(self, Text)
        return "<font color='" .. self:AccentColorRgb() .. "'>" .. Text .. "</font>"
    end
    ...
    do -- Elements
        Library.Watermark = function(self, Name)
            ...
            local function FormatAccentText(Text)
                return Text:gsub("<font color='rgb%([^%)]*%)'>(.-)</font>", function(Value)
                    return Library:AccentText(Value)
                end, 1)
            end
        ...
        Library.Window = function(self, Data)
            ...
            function Window:RefreshTitle()
                local CurrentText = Items["Title"].Instance.Text
                Items["Title"].Instance.Text = CurrentText:gsub("<font color='rgb%([^%)]*%)'>(.-)</font>", function(Value)
                    return Library:AccentText(Value)
                end, 1)
            end
        ...
        Library.Page = function(self, Data)
            ...
            local Items = { } do 
                ...
                local Icon = Library:GetCustomIcon(Page.Icon)
                Items["Icon"] = Instances:Create("ImageLabel", {
                    Parent = Items["Inactive"].Instance,
                    Name = "\0",
                    ImageTransparency = 0.5,
